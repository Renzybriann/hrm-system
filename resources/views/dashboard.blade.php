    ...
    <div class="mt-4">
        <div class="flex flex-wrap -mx-6">
            <div class="w-full px-6 sm:w-1/2 xl:w-1/3 mb-6">
                <div class="flex items-center px-5 py-6 bg-white rounded-lg shadow-md">
                    <div class="h-16 w-16 rounded-full bg-opacity-75 flex items-center justify-center">
                        <img src="{{ asset('icons/briefcase.png') }}" alt="Briefcase Icon" class="h-16 w-16">
                    </div>
                    <div class="mx-5">
            ...
            <div class="w-full px-6 sm:w-1/2 xl:w-1/3 mb-6">
                <div class="flex items-center px-5 py-6 bg-white rounded-lg shadow-md">
                    <div class="h-16 w-16 rounded-full bg-opacity-75 flex items-center justify-center">
                        <img src="{{ asset('icons/inbox.png') }}" alt="Briefcase Icon" class="h-16 w-16">
                    </div>
                    <div class="mx-5">
            ...
            <div class="w-full px-6 sm:w-1/2 xl:w-1/3 mb-6">
                <div class="flex items-center px-5 py-6 bg-white rounded-lg shadow-md">
                    <div class="h-16 w-16 rounded-full bg-opacity-75 flex items-center justify-center">
                        <img src="{{ asset('icons/ruser.png') }}" alt="Briefcase Icon" class="h-14 w-14">
                    </div>
                    <div class="mx-5">
    ...
    <div class="mt-4">
        <div class="flex flex-wrap -mx-6">
                ...
                <div class="flex items-center px-5 py-6 bg-white rounded-lg shadow-md">
                    ...
                    <div class="h-16 w-16 rounded-full {{ Auth::user()->hasVerifiedEmail() ? 'bg' : 'bg' }} bg-opacity-75 flex items-center justify-center">
                        @if (Auth::user()->hasVerifiedEmail())
                            ...
                            <img src="{{ asset('icons/verified.png') }}" alt="Verified Icon" class="h-16 w-16">
                        @else
                            {{-- Show the 'not-verified' icon --}}
                            <img src="{{ asset('icons/not-verified.png') }}" alt="Not Verified Icon" class="h-10 w-10">
                        @endif
                    </div>
            ...
            <div class="w-full px-6 sm:w-1/2 xl:w-1/3 mb-6">
                <div class="flex items-center px-5 py-6 bg-white rounded-lg shadow-md">
                    <div class="h-16 w-16 rounded-full bg-opacity-75 flex items-center justify-center">
                        <img src="{{ asset('icons/position.png') }}" alt="Briefcase Icon" class="h-16 w-16">
                    </div>
                    <div class="mx-5">
            ...
            <div class="w-full px-6 sm:w-1/2 xl:w-1/3 mb-6">
                <div class="flex items-center px-5 py-6 bg-white rounded-lg shadow-md">
                    <div class="h-16 w-16 rounded-full bg-opacity-75 flex items-center justify-center">
                        <img src="{{ asset('icons/job.png') }}" alt="Briefcase Icon" class="h-16 w-16">
                    </div>
                    <div class="mx-5">
